...
$app->addRoute('/add-product', 'GET', \Controller\ProductController::class, 'getAddProductForm');
$app->addRoute('/add-product', 'POST', \Controller\ProductController::class, 'addProduct');
